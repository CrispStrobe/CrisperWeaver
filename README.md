...
- **Compare transcripts side by side** — re-transcribe the same audio with different models and see a word-level diff with Jaccard similarity stats. Helps pick the best model for your domain.
...
- **Watch a folder for new audio** — point CrisperWeaver at a directory and new audio files are auto-transcribed. Desktop-only; configurable in Settings.
